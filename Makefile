...
# -*- MAKEFILE -*-
LIBNAME = libft.a
SRC_1 = ft_bzero.c ft_memccpy.c ft_memchr.c ft_memcmp.c ft_memcpy.c ft_memmove.c\
...
ft_atoi.c ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c ft_isprint.c ft_tolower.c ft_toupper.c
SRC_2 = ft_memdel.c ft_putendl.c ft_putnbr_fd.c ft_strclr.c ft_striter.c \
...
OBJ_1 = ft_bzero.o ft_memccpy.o ft_memchr.o ft_memcmp.o ft_memcpy.o ft_memmove.o\
...
ft_atoi.o ft_isalnum.o ft_isalpha.o ft_isascii.o ft_isdigit.o ft_isprint.o ft_tolower.o ft_toupper.o
OBJ_2 = ft_memdel.o ft_putendl.o ft_putnbr_fd.o ft_strclr.o ft_striter.o \
